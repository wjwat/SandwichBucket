    ...
    public partial class Another_One : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 26, 7, "You should eat this with a fork", "Meatball Sub" },
                    { 33, 0, "Who cares Ryan does!", "Reuben" },
                    { 27, 4, "Yum olives", "Muffuletta" },
                    { 28, 7, "Hand eating at its finest", "Pastie" },
                    { 29, 1, "That's it", "PB&J" },
                    { 30, 6, "Fold it", "Pizza" },
                    { 31, 5, "This is making me hungry", "Pulled Pork" },
                    { 32, 7, "", "Raining Sauce" },
                    { 25, 2, "Your mom's favorite", "It's My Sandwich In a Box" },
                    { 39, 6, "Maybe the best of all sandwiches", "Taco" },
                    { 35, 3, "No please don't 'member this horror", "Salad Fingers" },
                    { 36, 3, "666", "Seitan" },
                    { 37, 3, "Somehow this is a sandwich", "Spaghetti and Meatballs" },
                    { 38, 0, "An american sandwich", "Sub" },
                    { 40, 0, "yum", "Torta" },
                    { 41, 4, "Chicken of the sea", "Tuna Salad" },
                    { 42, 3, "(A Sandwich (cow's head))", "What's In The Box?" },
                    { 43, 7, "Some dirt between two 2 x 4s", "Wood" },
                    { 24, 6, "Who put it there?", "Ice Cream Sandwich" },
                    { 34, 7, "Gotta be with horsey sauce", "Roast Beef" },
                    { 23, 1, "Don't put ketchup on a hot dog", "Hot Dog" },
                    { 9, 8, "Damn fine", "Croque-monsieur" },
                    { 21, 0, "GYYY-ROOOE", "Gyro" },
                    { 22, 7, "Some words", "Ham and Swiss" },
                    { 2, 6, "Hell yes", "Banh Mi" },
                    { 3, 1, "Classic", "BLT" },
                    { 4, 1, "Watch out for the burglar", "Cheeseburger" },
                    { 5, 6, "Chop up", "Cheesesteak" },
                    { 6, 2, "Damn fine", "CherryPie" },
                    { 7, 1, "Chicken of the land", "Chicken Salad" },
                    { 8, 3, "Who am I?", "Chopped Liver" },
                    { 10, 6, "All kinds of pork", "Cubano" },
                    { 1, 8, "", "All Day I Dream About Sandwich" },
                    { 12, 0, "No More, No less", "Eat 16 Sandwiches" },
                    { 11, 0, "Veal or Beef??", "Doner kebab" },
                    { 19, 1, "(A Sandwich)", "Give Me Something To Eat" },
                    { 18, 0, "Turkey and slaw baby", "Georgia Reuben" },
                    { 17, 5, "", "Freak On A Sandwich" },
                    { 20, 3, "Mayo or Butter???", "Grilled Cheese" },
                    { 15, 1, "Chickpeas or Garbanzos?", "Falafel" },
                    { 14, 4, "", "F*ck You, Eat Me" },
                    { 13, 7, "You're either with it or against it", "Egg Salad" },
                    { 16, 2, "", "Falling Away From Meat" }
                });
