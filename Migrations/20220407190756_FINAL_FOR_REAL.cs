...
{
    public partial class FINAL_FOR_REAL : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 33, 8, "Who cares Ryan does!", "Reuben" },
                    { 27, 0, "Yum olives", "Muffuletta" },
                    { 28, 5, "Hand eating at its finest", "Pastie" },
                    { 29, 3, "That's it", "PB&J" },
                    { 30, 0, "Fold it", "Pizza" },
                    { 31, 5, "This is making me hungry", "Pulled Pork" },
                    { 32, 3, "From a delicious sky", "Raining Sauce" },
                    { 25, 2, "Your mom's favorite", "It's My Sandwich In a Box" },
                    { 39, 4, "Maybe the best of all sandwiches", "Taco" },
                    { 35, 2, "No please don't 'member this horror", "Salad Fingers" },
                    { 36, 1, "666", "Seitan" },
                    { 37, 1, "Somehow this is a sandwich", "Spaghetti and Meatballs" },
                    { 38, 1, "An american sandwich", "Sub" },
                    { 40, 0, "yum", "Torta" },
                    { 41, 8, "Chicken of the sea", "Tuna Salad" },
                    { 42, 7, "(A Sandwich (cow's head))", "What's In The Box?" },
                    { 43, 0, "Some dirt between two 2 x 4s", "Wood" },
                    { 24, 3, "Who put it there?", "Ice Cream Sandwich" },
                    { 34, 4, "Gotta be with horsey sauce", "Roast Beef" },
                    { 23, 4, "Don't put ketchup on a hot dog", "Hot Dog" },
                    { 9, 7, "Damn fine", "Croque-monsieur" },
                    { 21, 7, "GYYY-ROOOE", "Gyro" },
                    { 22, 8, "Some words", "Ham and Swiss" },
                    { 1, 7, "Yes, All Day", "All Day I Dream About Sandwich" },
                    { 3, 0, "Classic", "BLT" },
                    { 4, 4, "Watch out for the burglar", "Cheeseburger" },
                    { 5, 4, "Chop up", "Cheesesteak" },
                    { 6, 4, "Damn fine", "CherryPie" },
                    { 7, 4, "Chicken of the land", "Chicken Salad" },
                    { 8, 0, "Who am I?", "Chopped Liver" },
                    { 10, 7, "All kinds of pork", "Cubano" },
                    { 2, 0, "Hell yes", "Banh Mi" },
                    { 12, 8, "No More, No less", "Eat 16 Sandwiches" },
                    { 11, 6, "Veal or Beef??", "Doner kebab" },
                    { 18, 6, "Turkey and slaw baby", "Georgia Reuben" },
                    { 17, 5, "Are you feeling like it?", "Freak On A Sandwich" },
                    { 19, 5, "(A Sandwich)", "Give Me Something To Eat" },
                    { 15, 6, "Chickpeas or Garbanzos?", "Falafel" },
                    { 14, 8, "I'll get mine before you get yours", "F*dge You, Eat Me" },
                    { 13, 3, "You're either with it or against it", "Egg Salad" },
                    { 16, 0, "Nu-sandwich for sandwich-heads", "Falling Away From Meat" },
                    { 20, 7, "Mayo or Butter???", "Grilled Cheese" }
                });
